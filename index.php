...
<?php   echo "<b>ID:</b> " . $id . "<br>";   
        ...
        if ($tank!=""){
          echo "<br><b>N&aacute;dr&#382; s vodou:</b> " . $tank . " (cm)<br>"; } 
        echo "<br><b>D&eacute;&#353;&#357;ov&eacute; &#269;idlo: </b>";  if ($rain=='1'){ echo ("<font color='Red'>pr&#353;&iacute;</font>"); } else { echo ("<font color='Green'>bez de&#353;t&#283;</font>"); }
        if ($lastrun!=""){
          echo "<br><b>Naposledy b&#283;&#382;el:</b> " . $lastrun . "<br><br>"; } 
